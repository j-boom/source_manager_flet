...
class ProjectSourcesTab:
    ...
    def _init_containers(self):
        ...
        # Project Sources - main right column
    ...
    def _refresh_ui(self):
        ...
        # Add drag target for on-deck circle
        if self.on_deck_list.controls:
            self.on_deck_list.controls.append(
                ft.DragTarget(
                    ...
                    on_accept=self._on_drag_to_on_deck
                )
            )
        ...
        # Add drag target for project sources
