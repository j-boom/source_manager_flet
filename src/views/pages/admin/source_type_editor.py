...
class SourceTypeEditor(ft.Column):
    ...
    def __init__(self, type_name: str, controller, colors: ft.ColorScheme):
        ...
        self.colors = colors
        self.type_config: Dict[str, Any] = self.controller.admin_controller.get_source_type_config(type_name)
    ...
    def _build_ui(self):
        ...
        sorted_fields = sorted(self.type_config.get('fields', []), key=lambda f: f.get('display_order', 0))
        ...
        self.controls.extend([
            ...
            ft.Row([
                ft.ElevatedButton("Add Field", icon=ft.icons.ADD, on_click=self._on_add_field_clicked),
