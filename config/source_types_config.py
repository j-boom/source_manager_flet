...
ALL_SOURCE_FIELDS: Dict[str, SourceFieldConfig] = {
    ...
    "authors": SourceFieldConfig(name="authors", label="Authors (comma-separated)", field_type=FieldType.TEXT, hint_text="e.g., Smith, J., Doe, A."),
    "publication_year": SourceFieldConfig(name="publication_year", label="Year", field_type=FieldType.NUMBER, hint_text="e.g., 2023"),
